...
if(CMAKE_SYSTEM_PROCESSOR MATCHES "aarch64|arm64|ARM64")
  set(PHYNPU_DDK_LIB_DIR
      ${ONNXRUNTIME_ROOT}/core/providers/phynpu/phytium_npu_sdk/lib/arm64)
else()
  set(PHYNPU_DDK_LIB_DIR
      ${ONNXRUNTIME_ROOT}/core/providers/phynpu/phytium_npu_sdk/lib/x64)
endif()
...
add_custom_command(
  ...
  COMMAND ${CMAKE_COMMAND} -E make_directory $<TARGET_FILE_DIR:${build_output_target}>/onnxruntime/capi/npu_config
  COMMAND ${CMAKE_COMMAND} -E make_directory $<TARGET_FILE_DIR:${build_output_target}>/onnxruntime/capi/phytium_npu_sdk
  ...
  COMMAND ${CMAKE_COMMAND} -E copy
      ${ONNXRUNTIME_ROOT}/core/providers/phynpu/npu_config/*.json
      $<TARGET_FILE_DIR:${build_output_target}>/onnxruntime/capi/
  COMMAND ${CMAKE_COMMAND} -E copy
      ${PHYNPU_DDK_LIB_DIR}/*.so
      $<TARGET_FILE_DIR:${build_output_target}>/onnxruntime/capi/    
