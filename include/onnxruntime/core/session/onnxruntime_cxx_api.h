...
#ifdef USE_PHYNPU
  size_t SetPhyOutput(size_t index, const OrtValue* ort_value, int *out_arg_index) const;
  size_t SetPhyInput(size_t index, const OrtValue* ort_value, int *in_arg_index) const;
#endif
