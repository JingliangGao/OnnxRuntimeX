...
#endif
#ifdef USE_VITISAI
#include "core/providers/tensorrt/vitisai_provider_factory.h"
...
// ProviderFactoryCreator class declarations
#ifdef USE_CUDA
class CudaProviderFactoryCreator {
 public:
...
#ifdef USE_CANN
class CannProviderFactoryCreator {
 public:
...
#ifdef USE_DNNL
class DnnlProviderFactoryCreator {
 public:
...
#ifdef USE_MIGRAPHX
class MIGraphXProviderFactoryCreator {
 public:
  static std::shared_ptr<IExecutionProviderFactory> Create(int device_id);
  static std::shared_ptr<IExecutionProviderFactory> Create(const OrtMIGraphXProviderOptions* provider_options);
};
#endif

#ifdef USE_TENSORRT
class TensorrtProviderFactoryCreator {
 public:
  static std::shared_ptr<IExecutionProviderFactory> Create(int device_id);
...
#ifdef USE_OPENVINO
class OpenVINOProviderFactoryCreator {
 public:
...
#ifdef USE_VITISAI
class VitisAIProviderFactoryCreator {
 public:
...
#ifdef USE_TENSORRT
OrtTensorRTProviderOptionsV2 OrtTensorRTProviderOptionsToOrtTensorRTProviderOptionsV2(const OrtTensorRTProviderOptions* /*legacy_trt_options*/) {
  return OrtTensorRTProviderOptionsV2{};
}
#else
void OrtTensorRTProviderOptionsToOrtTensorRTProviderOptionsV2(const OrtTensorRTProviderOptions* /*legacy_trt_options*/) {
  // Empty implementation for CPU build
}
#endif
#endif
...
#else
  ORT_THROW("NVTX profiling is not available when CUDA is not enabled.");
#endif
}
...
ORT_API_STATUS_IMPL(OrtSessionOptionsAppendExecutionProvider_Dnnl, _In_ OrtSessionOptions* options, int use_arena) {
  ...
  return OrtApis::CreateStatus(ORT_FAIL, "DNNL execution provider is not enabled in this build.");
  API_IMPL_END
}
#endif
...
ORT_API_STATUS_IMPL(OrtSessionOptionsAppendExecutionProvider_Tensorrt, _In_ OrtSessionOptions* options, int device_id) {
  ...
  return OrtApis::CreateStatus(ORT_FAIL, "TensorRT execution provider is not enabled in this build.");
  API_IMPL_END
}
#endif
...
ORT_API_STATUS_IMPL(OrtSessionOptionsAppendExecutionProvider_MIGraphX, _In_ OrtSessionOptions* options, int device_id) {
  ...
  ORT_UNUSED_PARAMETER(options);
  ORT_UNUSED_PARAMETER(device_id);
  return OrtApis::CreateStatus(ORT_FAIL, "MIGraphX execution provider is not enabled in this build.");
  API_IMPL_END
}
#endif
...
ORT_API_STATUS_IMPL(OrtApis::SessionOptionsAppendExecutionProvider_OpenVINO, _In_ OrtSessionOptions* options,
  ...
  return OrtApis::CreateStatus(ORT_FAIL, "OpenVINO execution provider is not enabled in this build.");
  API_IMPL_END
}
#endif
...
ORT_API_STATUS_IMPL(OrtApis::SessionOptionsAppendExecutionProvider_CUDA, _In_ OrtSessionOptions* options, _In_ const OrtCUDAProviderOptions* cuda_options) {
  ...
  return OrtApis::CreateStatus(ORT_FAIL, "CUDA execution provider is not enabled in this build.");
  API_IMPL_END
}
#endif
...
ORT_API_STATUS_IMPL(OrtSessionOptionsAppendExecutionProvider_ROCM, _In_ OrtSessionOptions* options, int device_id) {
  ...
  ORT_UNUSED_PARAMETER(options);
  ORT_UNUSED_PARAMETER(device_id);
  return OrtApis::CreateStatus(ORT_FAIL, "ROCM execution provider is not enabled in this build.");
  API_IMPL_END
}
#endif
...
ORT_API_STATUS_IMPL(OrtApis::SessionOptionsAppendExecutionProvider_CANN,
  ...
  return OrtApis::CreateStatus(ORT_FAIL, "CANN execution provider is not enabled in this build.");
  API_IMPL_END
}
#endif
...
ORT_API_STATUS_IMPL(OrtApis::SessionOptionsAppendExecutionProvider_Dnnl,
  ...
  return OrtApis::CreateStatus(ORT_FAIL, "oneDNN execution provider is not enabled in this build.");
  API_IMPL_END
}
#endif
...
ORT_API_STATUS_IMPL(OrtApis::SessionOptionsAppendExecutionProvider_VitisAI, _In_ OrtSessionOptions* options,
  ...
  ORT_UNUSED_PARAMETER(provider_options_values);
  ORT_UNUSED_PARAMETER(num_keys);
  return OrtApis::CreateStatus(ORT_FAIL, "VitisAI execution provider is not enabled in this build.");
  API_IMPL_END
}
#endif
