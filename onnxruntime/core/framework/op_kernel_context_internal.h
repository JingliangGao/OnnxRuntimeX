...
class OpKernelContextInternal : public OpKernelContext {
 public:
  ...
  const Status SetPhyOutputMLValue(int index, const OrtValue* ort_value, int* out_arg_index) const {
    return OpKernelContext::SetPhyOutputMLValue(index, ort_value, out_arg_index);
  }

  const Status SetPhyInputMLValue(int index, const OrtValue* ort_value, int *in_arg_index) const {
    return OpKernelContext::SetPhyInputMLValue(index, ort_value, in_arg_index);
  }
