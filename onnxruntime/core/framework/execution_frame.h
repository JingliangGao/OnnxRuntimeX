...
class IExecutionFrame {
 ...
 public:
  ...
  const Status SetPhyOutputMLValue(int index, const OrtValue* ort_value, int *out_arg_index);
  const Status SetPhyInputMLValue(int index, const OrtValue* ort_value, int *in_arg_index);
