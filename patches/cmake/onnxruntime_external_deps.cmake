...
# Prefer system re2 found via pkg-config. If not found, fall back to FetchContent to download/build re2.
...
if(RE2_FOUND)
  ...
  message(STATUS ">> Using system RE2 via pkg-config.")
else()
   # 原先内容
  message(STATUS ">> Using external RE2 via github")
endif()
